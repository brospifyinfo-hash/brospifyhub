-- =============================================
-- BROSPIFY HUB – IN DIE DATENBANK EINFÜGEN
-- =============================================
-- WICHTIG: Dies ist eine SQL-Datei! Kommentare sind -- (zwei Minus).
-- Kein // verwenden (gilt nur für JavaScript/TypeScript).
-- 1. Supabase öffnen → SQL Editor → New Query
-- 2. Inhalt NUR aus DIESER .sql-Datei kopieren (nicht aus .ts!)
-- 3. RUN klicken
-- =============================================
